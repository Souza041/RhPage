...
ob_start();
?>
<h2>Solicitação reaberta</h2>

<p>A solicitação foi reaberta e enviada novamente para aprovação.</p>
...
<p><strong>Observação do ajuste:</strong><br>
<?php echo nl2br(htmlspecialchars($dados['observacao_reabertura'])); ?></p>
<?php
return ob_get_clean();